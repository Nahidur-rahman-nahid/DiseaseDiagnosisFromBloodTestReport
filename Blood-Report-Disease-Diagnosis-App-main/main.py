...
def extract_cbc_values(image_path):
    ...
    try:
        ...
        # Convert the image to bytes with lower quality to reduce size
        ...
        # Generate response using vision model with retry logic
        max_retries = 3
        ...
        print(f"Error in extract_cbc_values: {str(e)}")
        return None
...
def gemini_analysis():
    if request.method == 'POST':
        ...
        prompt = f"""
            ...
            Please provide:
            1. A short explanation of what each CBC component normally indicates.
            ...
            4. Make clear that these are **educational insights only**, not a medical diagnosis.
